    ...
    <article>
        ...
        >
            ...
            <p class="text-center opacity-80">
                ...
                purposes. From translation, moderation, cat photos, and to
                scrolling Reddit. It is built with interactivity in mind, and
                utilizes many of Discord's new API features such as buttons,
                modals, and selection menus.
            </p>
        ...
        <section class="flex flex-col mx-auto w-full max-w-4xl">
            ...
            <div class="flex flex-col gap-4 md:flex-row">
                ...
                <Feature class="flex-1">
                    ...
                    <template v-slot:description>
                        <p class="text-sm opacity-80">
                            Xylo replaces the typical reaction roles with a
                            modern alternative using selection menus. Easily
            ...
            >
                ...
                >
                    ...
                    <p class="opacity-80">
                        ...
                        . They can be used for an undo button to a warning, to
                        go to the next post in the reddit command, or for simple
                        games.
                    </p>
                </div>
            ...
            >
                ...
                >
                    ...
                    <p class="opacity-80">
                        ...
                        alternatives, like selection menus.
                    </p>
                </div>
                <DiscordMessage class="flex-1">
                    <DiscordEmbed>
